...
<head>
	...
	<link rel="shortcut icon" href="<?= base_url() ?>/kubo2020.png" />
	<link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>/kubo2020.png">
	<link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>/kubo2020.png">
	<link rel="apple-touch-icon" href="<?= base_url() ?>/kubo2020.png">
